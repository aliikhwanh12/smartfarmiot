  ...
  <FullScreenLayout>
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
      ...
      >
        ...
        <div
          class="relative lg:grid items-center hidden lg:w-1/2 animated-background bg-gradient-to-br from-asparagus to-yellowgreen dark:bg-white/5 rounded-2xl p-6 my-2 mx-3"
        >
          <div class="flex items-center justify-center z-1">
            <div class="flex flex-col items-center max-w-xs">
              <img src="/images/other/login.svg" alt="Logo" />
            </div>
          </div>
        </div>
      </div>
